...
function finchLED(red, green, blue) {
    $.get(`../finch/out/led/${red}/${green}/${blue}`, function(data){
...
function finchMotor(left,right) {
    $.get(`../finch/out/motor/${left}/${right}`, function(data){
...
function finchBuzzer(frequency,duration) {
    $.get(`../finch/out/buzzer/${frequency}/${duration}`, function(data){
...
function finchSpeak(message) {
    $.get(`http://192.168.1.105:22179/speak/${message}`, function(data){
...
function finchTemperature() {
    $.get(`../finch/in/temperature`, function(data){
...
function finchBrightness() {
    $.get(`../finch/in/lights`, function(data){
...
function finchCrashDetection() {
	$.get(`../finch/in/obstacles`, function(data){
		  var sensors = data.split(" ");
