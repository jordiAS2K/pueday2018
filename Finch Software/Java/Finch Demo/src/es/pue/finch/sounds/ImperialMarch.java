...
class ImperialMarch {
    ...
    public static void main(String[] args)   {
        ...
        finch.buzzBlocking(C4,S);
        finch.sleep(1+S);
        finch.buzzBlocking(LA3,H);
        finch.sleep(1+H);

        finch.buzzBlocking(E4,Q); 
        finch.sleep(1+Q); 
        finch.buzzBlocking(E4,Q);
        finch.sleep(1+Q);
        finch.buzzBlocking(E4,Q);
        finch.sleep(1+Q);
        finch.buzzBlocking(F4,E+S);
        finch.sleep(1+E+S);
        finch.buzzBlocking(C4,S);
        finch.sleep(1+S);

        finch.buzzBlocking(AB3,Q);
        finch.sleep(1+Q);
        finch.buzzBlocking(F3,E+S);
        finch.sleep(1+E+S);
        finch.buzzBlocking(C4,S);
        ...
        finch.buzzBlocking(LA4,Q);
        finch.sleep(1+Q);
        finch.buzzBlocking(LA3,E+S);
        finch.sleep(1+E+S);
        finch.buzzBlocking(LA3,S);
        finch.sleep(1+S);
        finch.buzzBlocking(LA4,Q);
        finch.sleep(1+Q);
        finch.buzzBlocking(AB4,E+S);
        finch.sleep(1+E+S);
        finch.buzzBlocking(G4,S);
        finch.sleep(1+S);

        finch.buzzBlocking(GB4,S);
        finch.sleep(1+S);
        finch.buzzBlocking(E4,S);
        finch.sleep(1+S);
        finch.buzzBlocking(F4,E);
        finch.sleep(1+E);
        finch.sleep(1+E);//PAUSE
        finch.buzzBlocking(BB3,E);
        finch.sleep(1+E);
        finch.buzzBlocking(EB4,Q);
        finch.sleep(1+Q);
        finch.buzzBlocking(D4,E+S);
        finch.sleep(1+E+S);
        finch.buzzBlocking(DB4,S);
        finch.sleep(1+S);

        finch.buzzBlocking(C4,S);
        finch.sleep(1+S);
        finch.buzzBlocking(B3,S);
        finch.sleep(1+S);
        finch.buzzBlocking(C4,E);
        finch.sleep(1+E);
        finch.sleep(1+E);
        finch.buzzBlocking(F3,E);
        finch.sleep(1+E);
        finch.buzzBlocking(AB3,Q);
        finch.sleep(1+Q);
        finch.buzzBlocking(F3,E+S);
        ...
        finch.buzzBlocking(C4,Q);
        finch.sleep(1+Q);
        finch.buzzBlocking(LA3,E+S);
        finch.sleep(1+E+S);
        finch.buzzBlocking(C4,S);
        finch.sleep(1+S);
        finch.buzzBlocking(E4,H);
        finch.sleep(1+H);
